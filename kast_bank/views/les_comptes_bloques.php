...
<html>
    <head>
        ...
        <?php include("../controllers/getListeComptesBloques.php") ?>
    </head>
    <body>
        <header class="min-vh-100">
            <form action="../controllers/bloquerCompte.php" method="POST">
                ...
                ?>
                <center>
                    <h2 style="margin-left: 100px;margin-top: 40px;">Les comptes Bloques</h2>
                </center>
                <table class="table table-striped table-hover table-sm" style="text-align: center;">
                <caption class="caption-top">Liste des comptes bloques</caption>
                <thead class = "table-dark">
                    ...
                    <?php
                        $comptes = getListeComptesBloques();
                        $num = 1;
                        for($i = 0; $i < count($comptes); $i++){
                            ...
                            echo "<td><a onclick=\"confirm(alert('voulez-vous Annuler le blocage de ce compte?'))\" href=\"./fermer_compte.php?annul=".$comptes[$i]->getNum_compte()."\">"."Annuler"."</a>"."</td>";
                            echo "</tr>";
