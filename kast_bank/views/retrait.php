...
<body>
    ...
    <main class="min-vh-100">
        <div class="div-9">
            <div class="">
                <form action="../controllers/enregistrer_retrait.php" class="d-flex flex-column gap-3 m-auto col-10 col-md-7 col-xl-4" method="post" enctype="multipart/form-data">
                    <div class="">
                        <div class="form-div mb-5 mt-3">
                            <center><h1 class="title-form">Retirer de l'argent</h1></center>
                        </div>
                        <div class="form-div mb-3 text-start">
                            <label for="montant" class = "form-label text-start">Numero de retrait :</label>
                            <input type="number" name="num_retrait" id="" class="form-control" placeholder="Numero de retrait" required autocomplete="off">
                        </div>
                        <div class="form-div mb-3 text-start">
                            <label for="date_retrait" class = "form-label text-start">Date de retrait :</label>
                            <input type="date" name="date_retrait" id="" class="form-control" placeholder="Date de retrait" required autocomplete="off">
                        </div>
                        <div class="form-div mb-3 text-start">
                        ...
                        <div class="p-3 m-auto text-center mb-3 mt-3">
                            <button type="submit" name="save" class="btn btn-primary border-0 py-2 px-3" style="background-image: linear-gradient(to right, #34A0A4, #557BAF);height:40px; text-align: center; align-items: center;">Valider</button>
                            ...
                            <button type="submit" name="save" class="btn btn-primary border-0 py-2 px-3" style="background-image: linear-gradient(to right, #34A0A4, #557BAF);height:40px; text-align: center; align-items: center;"><a href="./les_retraits.php" style="color: #fff;">les retraits</a></button>
                        </div>
                </form>
            </div>
        </div>
